...
describe('Testing functions written using lodash', function () {
	...
	it('Testing a function that returns all the values of employess name array in capital letters', function () {
		expect(LodashExample.nameInCapital(['amshu', 'madhur', 'surbir', 'arsh', 'harshit'])).to.be.deep.equal([
			'AMSHU',
			'MADHUR',
			'SURBIR',
			'ARSH',
